<div id="editKelas" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5 modal-content">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('classes.edit') }}" method="POST">
                        @csrf
                        <input type="hidden" id="id_cls" name="id_cls">
                        <div class="flex flex-wrap">
                            <div class="relative z-0 w-full sm:w-1/2 mb-6 group">

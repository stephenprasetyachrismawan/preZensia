                                    ...
                                    <div class="card w-90 glass mb-2 ">
                                        <div class="card-body">
                                            <div class="card-actions justify-end m-0">
                                                <div class="dropdown dropdown-end">
                                                    ...
                                                    <ul tabindex="0"
                                                        ...
                                                        @if ($d[1] == 1)
                                                            <li><button class="unarchive" data-id='{{ $d[3] }}'
                                                                    data-modal-target="unarchive-modal"
                                                                    data-modal-toggle="unarchive-modal"
                                                                    type="button">Unarchive</button></li>
                                                            <li><button class="btnHapus" data-id='{{ $d[5] }}'
                                                                    data-modal-target="hapus-modal"
                                                                    data-modal-toggle="hapus-modal" type="button">Hapus
                                                                    Kelas</button></li>
                                                        @else
                                            ...
                                            <h2 class="card-title">{{ Str::limit($d[4], 14, '...') }} <span
                                                    class="underline underline-offset-1">{{ Str::limit($d[0], 7, '...') }}
                                            </h2>
                                            <p>Teacher :
                                                @if ($d[1] == 1)
                                            ...
                                            @if ($d[1] == 1)
                                                <div class="card-actions justify-end">
                                                    <button class="unarchive btn btn-primary"
                                                        data-id='{{ $d[3] }}'
                                                        data-modal-target="unarchive-modal"
                                                        data-modal-toggle="unarchive-modal"
                                            ...
                                            @else
                                                <div class="card-actions justify-end">
                                                    <button
                                                        class="btn btn-primary cursor-not-allowed focus:outline-none"
                                                        type="button" disabled>Unarchive</button>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                    <img src="https://picsum.photos/id/44/4272/2848" alt="Image 1"
